...
# %% [markdown]
# Compare each degrees within the STEM category between the genders

# %%
women_degrees = pd.read_csv(
    "Projects\\Project5_Gender_Gap_College_Degrees\\percent-bachelors-degrees-women-usa.csv"
)
...
for sp in range(1, 16, 3):
    ...
    ax.plot(
        women_degrees["Year"],
        women_degrees[lib_arts_cats[cat_index]],
        c=cb_dark_blue,
        label="Women",
        linewidth=3,
    )
    ax.plot(
        women_degrees["Year"],
        100 - women_degrees[lib_arts_cats[cat_index]],
        c=cb_orange,
        label="Men",
        linewidth=3,
    )
...
for sp in range(2, 18, 3):
    ...
    ax.plot(
        women_degrees["Year"],
        women_degrees[other_cats[cat_index]],
        c=cb_dark_blue,
        label="Women",
        linewidth=3,
    )
